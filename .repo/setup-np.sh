...
git remote set-url --add --push origin https://np@scm.icebergsys.net/git/tools/eventboard
git remote set-url --add --push origin https://nicholaspaun@github.com/nicholaspaun/eventboard.git
